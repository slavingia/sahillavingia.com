...
export default function Home() {
  ...
  <main className="prose mx-auto p-4 sm:p-8 flex-1 w-full max-w-3xl relative z-10">
    ...
    <p>
      ...
      businesses around the world. Therefore, optimization isn't enough to build
      the singular businesses investors like Paul are hoping to invest in.
    </p>

    <p>The third point of god mode defines founder mode: destruction.</p>

    <p>
      Destruction is akin to invasive surgery, and similar to surgery, it's only
      possible with a god-like omniscience about the entire system.
    </p>

    <p>
      This also means that god mode is only possible within the rare businesses
      where a single person can have complete omniscience about their business;
      companies like Gumroad and Airbnb.
    </p>

    <p>
      Which is rare. In Hinduism, even, the universe is created, preserved, and
      destroyed in a cycle of repeated events by three gods:
    </p>

    <ul>
      <li>
        <strong>Creation:</strong> Brahma is the creator of the universe, having
        made it from himself.
      </li>
      <li>
    ...
    <p>
      Christianity innovates on this concept by combining all three gods into a
      single Godhead, with total omniscience.
    </p>

    <h2>Solo Founder Mode</h2>

    <p>
      In 2023, Gumroad doubled "our" pricing to 10% flat. But really, <em>I</em>{" "}
      did.
    </p>

    <p>
      No one else would have made the same decision–it put the entire company at
      risk. But from my perspective, the entire company was already dead, and I
      needed to do something aggressive to save it.
    </p>

    <p>
      Before doing so, I asked my team, top customers, and many of our investors
      whether it was a good idea. No one thought so. It turns out, no one agreed
      with me that increasing our pricing so drastically and dramatically–and
      directly, I went with an email blast titled "simpler, higher pricing"–was
      a good idea, but I believed it was the right thing to do, and did it
      anyway.
    </p>

    <p>
      (Why ask them then? Because they could have changed my mind. While I
      didn't have to follow their advice, it was important to make sure I wasn't
      missing something. I've disbanded many dramatic ideas due to feedback.)
    </p>
    ...
    <p>
      None of this comes off as super likable. And it's not fun to be disliked.
      It paints "founder mode" vs "manager mode" as something more like
      "dictatorship" vs "democracy."
    </p>

    <p>
      But when your company is on the brink, you'll do what's necessary to save
      it. If that requires becoming a benevolent dictator, like Lee Yuan Yew had
      to do to resurrect Singapore, it becomes worth it.
    </p>
    ...
    <p>
      YC states in{" "}
      <a href="https://www.youtube.com/watch?v=prKi3-rUPHc&t=27s">this video</a>{" "}
    ...
    <ol>
      ...
      <li>
        ...
        associated with a single famous figure, it's important to remember that
        at their earliest stages, even companies like Apple, Facebook, Google,
        and Microsoft all began with co-founders."
      </li>
    </ol>
    ...
    <p>
      ...
      potential great co-founder an equal 50% share can be the best decision to
      ensure their full commitment and motivation throughout the startup
      journey."
    </p>
    ...
    <p>
      One reason may be that having cofounders requires you to have convinced at
      least one other person to join you on your journey. This acts as a filter
      so that YC doesn't have to review as many applications. It also requires
      non-technical founders–most would-be applicants–to invest the time in
      finding a technical co-founder, spreading the gospel of YC on their
      behalf.
    </p>

    <p>
      But I don't think that's the core motivation. I think the core motivation,
    ...
    <p>
      ...
      change WordPress against the best wishes of its users, but maybe it's also
      necessary.
    </p>
    ...
    <p>
      (Or maybe Matt's right, and we'll all realize that several years from now.
      He knows stuff the rest of us don't.)
    </p>
    ...
    <p>
      I can speak from experience. I started Gumroad as a solo founder in 2011,
      raised two rounds of venture in 2011 and 2012, and–after failing to raise
      a third round–laid everyone except myself off in 2015.
    </p>

    <p>
      As part of a failed attempt to sell the business in 2017, I put together a
      one-pager with what manual tasks remained:
    </p>

    <div className="border-4 border-gray-300 rounded-lg p-4 py-0">
      <img src="/god-mode.png" alt="Gumroad tasks" className="w-full h-auto" />
    </div>
    ...
    <p>
      ...
      realized that I didn't really–I could do it all myself. It wasn't fun, but
      it was possible–and it led to a much healthier business–albeit a much less
      healthier me.
    </p>
    ...
    <p>
      Airbnb is a public company and what matters most now is Free Cash Flow. I
      think they'll get there the same way Gumroad did: by replacing every
      manual process with an automated one, by pushing all marginal costs to the
      customer, and having almost no employees.
    </p>
    ...
    <p>
      ...
      eliminated, even if that's the right thing for the business or the world.
    </p>
