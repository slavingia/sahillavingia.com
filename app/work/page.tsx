  ...
  return (
    <main className="prose dark:prose-invert mx-auto p-4 sm:p-8 flex-1 w-full max-w-3xl relative z-10">
      ...
      <p>
        ...
        "ten or so." That's how I convert the number of people we have into
        what others expect. But the truth is more complicated:
      </p>
      ...
      <p>
        ...
        generate $11 million in annualized revenue, growing 85%
        year-over-year.
      </p>
      <img
      ...
      <p>
        These contractors saved the company. They fixed bugs and maintained
        the site while I answered support tickets, designed features, and
        wrote about new initatives.
      </p>
      <p>
      ...
      <p>
        ...
        company, I acquired a new asset: time. I used that time to take
        classes on writing and painting.
      </p>
      <p>
        Because I was burned out and didn't want to think about working any
        more than I needed to, I instituted a no-meeting, no-deadline culture.
      </p>
      <p>
        For me, it was no longer about growth at all costs, but "freedom at
        all costs."
      </p>
      <p>
        This way, Gumroad stayed profitable, I could take a much-needed break
        to explore my hobbies, and the product continued to improve over time.
      </p>
      <img
        src="/operating.png"
      ...
      <p>
        ...
        expensive feedback loops to collaborate, working this way requires
      ...
      <p>
        There are no deadlines either. We ship incrementally, and launch
        things whenever the stuff in development is better than what's
        currently in production. The occasional exception does exist, such as
        a tax deadline, but as a rule, I try not to tell anyone what to do or
        how fast to do it. When someone new joins the company, they do what
        everyone else does: go into our Notion queue, pick a task, and get to
        work, asking for clarification when needed.
      </p>
      <p>
        Instead of setting quarterly goals or using OKRs, we move towards a
        single north star: maximizing how much money creators earn. It's
        simple and measurable, allowing anyone in the company to do the math
        on how much a feature or bug-fix might be worth.
      </p>
      ...
      <p>
        Gumroad engineer Helen Hood, who shipped Memberships, says, "it's one
        of the biggest product launches of my career, and we shipped it
        without a single meeting or video call. I've worked at your typical
        startup, with an open floor plan, lots of whiteboards, standups and
        sprint planning, beers after work. I've also worked on a remote team
        with little communication and engineers largely siloed on their own
        projects. The way we work at Gumroad is ideal for me. It lets me
        maximize my productive hours, and clock out when I've hit my limit."
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            ...
            we move on. The journey is the fun part, we're not waiting to
        ...
        <li>
          ...
          <p>
            ...
            likely be a few leadership roles, there aren't plenty of them and
            they aren't built into the career path of working at Gumroad."
          </p>
        </li>
      </ul>
      <p>
        ...
        engineers get to do more and learn more, which benefits them in the
        long term."
      </p>
      ...
      <p>
        <em>Everything</em> is handled this way: support, risk, content,
        growth, product prioritization, board decks, design feedback, and
        more.
      </p>
      ...
      <p>
        ...
        are limited opportunities for growth. And we can't compete with the
        comp packages that big tech companies can provide.
      </p>
      ...
      <p>
        In his words, "most entrepreneurs have two options: work a full-time
        job and hustle nights/weekends, or leave your job and risk everything
        to start the company. Gumroad provided a third way: I could contract
        20-35 hours a week, and for a couple days a week, incubate ideas and
        work on my next thing."
      </p>
      <p>
      ...
      <p>
        ...
        parts of their lives they prefer to spend their time and energy on: a
        creative side-hustle, their family, or anything else.
      </p>
      <p>
      ...
      <p>
        ...
        today, it is just a part of my life, like a hobby might be. For
      ...
      <blockquote className="dark:text-neutral-100">
        ...
        daily. Don't know if this is the type of commitment you had in mind,
        but I figured if there's a place where this arrangement can work, it's
        Gumroad :)
      </blockquote>
      ...
      <p>
        ...
        Amazon, he was making over $400,000 a year. We pay him $120,000 a
        year.
      </p>
      ...
      <p>
        ...
        Gumroad is responsible for their own healthcare and benefits. Everyone
        also pays for their own phone, laptop, internet connection, and all
      ...
      <p>
        ...
        instead of the other way around. Why not adopt this framing at
        Gumroad, too?
      </p>
      <p>
      ...
      <p>
        The internet has enabled new ways of working, but we're just starting
