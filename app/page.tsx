    ...
    <div className="min-h-screen flex items-center dark:bg-black">
      <main className="py-6 sm:py-10 px-4 sm:px-8 mx-auto max-w-4xl w-full">
        <header className="mb-6 sm:mb-8 flex justify-between items-center">
          <div>
            <h1 className="text-xl sm:text-2xl font-bold dark:text-white">Sahil Lavingia</h1>
            <div className="flex space-x-4 text-sm text-gray-600 dark:text-neutral-400">
              <a href="https://www.antiwork.com" className="no-underline dark:text-neutral-300">
                Founder
              </a>
              <span>Writer</span>
              <span>Painter</span>
          ...
          <a href="https://x.com/shl" className="no-underline text-2xl dark:text-white">
            𝕏
          </a>
        </header>
