...
export default function Home() {
  return (
    <div className="min-h-screen flex items-center bg-white dark:bg-black border-none">
      <main className="py-6 sm:py-10 px-4 sm:px-8 mx-auto max-w-4xl w-full">
        <header className="mb-6 sm:mb-8 flex justify-between items-center">
          <div>
            ...
            <div className="flex mt-3 space-x-2 text-sm text-gray-500 dark:text-gray-400">
        ...
        <div className="space-y-4 sm:space-y-6 pt-10">
          ...
          <h2 className="text-lg sm:text-xl">
            <ExternalLink
              ...
              className="font-bold underline dark:text-neutral-200 dark:hover:text-neutral-100"
            >
