...
export default function Home() {
  return (
    <Layout>
      ...
      <main className="centered-main mx-auto p-4 sm:p-8 flex-1 w-full max-w-3xl relative z-10">
        <label className="block text-gray-600 mt-8 mb-8 text-lg leading-6">
          May 20, 2024 by <a href="/" className="text-black dark:text-white"><u>Sahil Lavingia</u></a>
        </label>

        <h2 className="item mt-2 font-bold text-3xl leading-none">Paying Freelancers in Equity and Dividends</h2>

        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
        ...
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
          ...
          <a href="https://www.notion.so/gumroad/Getting-paid-1d0a875413444556953d044bc4502469#71bfd72228bf4b88815c6e665d2f32e1" className="text-black dark:text-white">
            Getting Paid
          </a>{" "}
        ...
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
          ...
          way to becoming <a href="/reflecting" className="text-black dark:text-white">a billion-dollar company</a>,
        ...
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
          <img src="/dividends/metrics2019.png" className="max-w-full my-4 mx-auto" />
        </p>
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
          In January 2020, I moved to Portland, Oregon for my wife's job. Then,
          COVID happened.
        </p>
        <h2 className="mt-8 font-bold text-3xl leading-none">COVID, Equity Crowdfunding, Creator Economy</h2>
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
        ...
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
          <img src="/dividends/metrics2020.png" className="max-w-full my-4 mx-auto" />
        </p>
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
        ...
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
          ...
          <a href="https://flexile.com/" className="text-black dark:text-white">Flexile</a>, to productize the way we
          worked, with{" "}
          <a href="/work" className="text-black dark:text-white">
        ...
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
          <img src="/dividends/metrics2022.png" className="max-w-full my-4 mx-auto" />
        </p>
        <h2 className="mt-8 font-bold text-3xl leading-none">Charging more</h2>
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
        ...
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
          <img src="/dividends/pricing2.png" className="max-w-full my-4 mx-auto" />
        </p>
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
        ...
        <h2 className="mt-8 font-bold text-3xl leading-none">Delving into dividends</h2>
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
        ...
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
          With{" "}
          <a href="https://x.com/shl/status/1679308995268587522" className="text-black dark:text-white">
            a couple emails
          </a>{" "}
        ...
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
          ...
          our cap table, using <a href="https://flexile.com" className="text-black dark:text-white">Flexile</a>.
        </p>
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
        ...
        <h2 className="mt-8 font-bold text-3xl leading-none">Splitting equity hairs</h2>
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
        ...
        <h2 className="mt-8 font-bold text-3xl leading-none">Equity by the hour</h2>
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
        ...
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
          <img src="/dividends/equitybythehour.png" className="max-w-full my-4 mx-auto" />
        </p>
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
        ...
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">There are no cliffs.</p>
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
        ...
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
          ...
          <a href="https://lazytigerhostel.com/" className="text-black dark:text-white">my own business</a> this year."
        </p>
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
          I made{" "}
          <a href="https://docs.google.com/spreadsheets/d/1OvHmIg5MA72oot-jRW-whEBROSmcMXcMRvFqkKfiQFM/edit#gid=805394775" className="text-black dark:text-white">
            a calculator
          </a>{" "}
        ...
        <h2 className="mt-8 font-bold text-3xl leading-none">D'end</h2>
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
        ...
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
          Now, we host{" "}
          <a href="https://www.youtube.com/watch?v=qUYSTvJnIXA" className="text-black dark:text-white">
        ...
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
          <img src="/dividends/metrics2023.png" className="max-w-full my-4 mx-auto" />
        </p>
        <p className="mt-8 text-lg leading-7 text-gray-900 dark:text-gray-200">
          If you’d like to follow along,{" "}
          <a href="https://us02web.zoom.us/webinar/register/WN_zUIicnMhSe2sMGGwycGyjg#/registration" className="text-black dark:text-white">
            register
          </a>{" "}
