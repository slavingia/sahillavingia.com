  ...
  return (
    <Layout>
      ...
      <main className="centered-main">
        ...
        <p>Since the beginning of 2024, Gumroad has raised $180,178 from our global team of hourly freelancers, at the same $100M valuation we used for our 2021 crowdfunding round. Upon exercising, they're entitled to dividends proportional to their equity ownership in the business.</p>
        ...
        <p>Fortunately, we had been building Flexile, to solve our own problem of paying remote workers, all over the world. Why not add dividends to it? We decided to DIY.</p>
        <p>A few months later, in July 2023, we issued a $1M trial dividend to our cap table, using Flexile. Armed with cash, wife and I started planning a move to NYC to start a family.</p>
        <p>To align the team, I proposed an end-of-year equity bonus, tied to the amount billed for the prior calendar year and our last public valuation.</p>
        <p>For example, someone who earned $198K would have received an additional 100%, or $198K, in Gumroad stock options, tied to the $100M crowdfunding valuation.</p>
        ...
        <p>All in all, equity was valuable to me, but not seen as valuable by the median freelancer. Why bother?</p>
        ...
        <p>In hindsight, I wasn’t a great employee. But I was a good freelancer. Before joining Pinterest full-time, I freelanced for them remotely. But I wanted to earn startup equity, so I dropped out.</p>
        ...
        <p>Today, Gumroad pays $125-$200/hr. This doesn’t change based on where you live.</p>
        <p>Of this hourly rate, you choose how much you’d like to get in equity: between 0 and 80%.</p>
        ...
        <p>Future liquidity is hard to reason about. $1 in your pocket now is worth more than $1 in your pocket a year from now. But how much more? That’s different for each person. For example:</p>
        ...
        <p>Someone even chose 80%: “Living from the 20% is enough for us. I know and trust the team who runs Gumroad, and have been planning to start long-term investing anyway.”</p>
        ...
        <p>It can be confusing, so I made <a href="https://docs.google.com/spreadsheets/d/1OvHmIg5MA72oot-jRW-whEBROSmcMXcMRvFqkKfiQFM/edit#gid=805394775">a calculator</a> to help.</p>
        ...
        <h2>D'end</h2>
        <p>Since the beginning of 2024, Gumroad has "saved" $180,178 by allowing our global team of hourly freelancers to swap cash for equity.</p>
        <p>Yesterday, we issued our second dividend, of $5.34M, equal to 60% of 2023’s net income. For the first time, our global team of freelancers were able to participate.</p>
        <p>I think our equity model is pretty cool. Mostly because if something like this existed back when I was still in school, perhaps I wouldn't have dropped out. My mom agrees: a college degree would be worth the confusion. What think you?</p>
