  ...
  return (
    <Layout>
      ...
      <main className="centered-main">
        ...
        <p>For years, my only metric of success was building a billion-dollar company. Now, I realize that was a terrible goal.</p>
        ...
        <label className="centered">
          Sign up for monthly updates about Gumroad
        </label>
