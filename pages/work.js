    ...
    <Layout>
      ...
      <main className="prose mx-auto p-4 sm:p-8 flex-1 w-full max-w-3xl relative z-10">
        <label className="block mt-8 mb-8">
          Jan 7, 2021 by <a href="/"><u>Sahil Lavingia</u></a>
        </label>
        ...
        <img src="/2020-earnings.png" alt="2020 earnings" className="max-w-full my-4 mx-auto" />
        <p>That said, I don't expect anyone to copy our way of working wholesale. We got here on accident, not some grand plan.</p>
        <p>However, I do think there are pieces of our story and the way we work that could benefit other companies, their people, and&mdash;most importantly&mdash;their customers.</p>
        <h2>Freedom at all costs</h2>
        <p>After the layoffs in 2015, even though the team shrunk, Gumroad itself continued to grow.</p>
        <img src="/2018-earnings.png" alt="2018 earnings" className="max-w-full my-4 mx-auto" />
        ...
        <img src="/operating.png" alt="Operating expenses versus creator earnings chart" className="max-w-full my-4 mx-auto" />
        <h2>How we work</h2>
        ...
        <p>People can work on what's fun or rely on their intuition, because as long as we remain profitable and keep shipping, we tend to get to the important stuff eventually. Our <a href="https://www.youtube.com/watch?v=CNes_Qfo0gw">public board meetings</a> help Gumroad's creators hold us accountable.</p>
        ...
        <img src="/memberships-roadmap.png" alt="Memberships roadmap" className="max-w-full my-4 mx-auto" />
        ...
        <p>Justin Mikolay, a writer at Gumroad, ships each of our <a href="https://gumroad.com/l/BCMDz">Creator Spotlights</a> this way, even though each one requires at least three people&mdash;plus the creator.</p>
        ...
        <p>He was already using the product&mdash;so he understood what problems Gumroad ought to solve next&mdash;and he had some ideas for how he could help out:</p>
        ...
        <p>Nobody accepted.</p>
        <p>I realized then that I was trying to copy the status quo&mdash;to try and fix something that wasn't broken&mdash;so that I could feel better about doing things the "normal" way.</p>
        ...
        <p>Meet the Gumroad team: <img src="/gumroadians.png" alt="Cartoon illustrations of the Gumroad team" className="max-w-full my-4 mx-auto" /></p>
